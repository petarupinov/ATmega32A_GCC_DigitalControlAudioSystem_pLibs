...
*** FILE NAME: lcd_hd44780_74hc595.h, v0.03, 29.11.2015      *************
...
void LCD_DATA_UINT(unsigned int data);
void LCD_DATA_INT(int data);
void LCD_DATA_LONG(long data);
void LCD_DATA_ULONG(unsigned long data);
